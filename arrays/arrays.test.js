...
describe("Array Extensions", function () {
    ...
    describe("first", function () {
        ...
        it("Exercise test 2", function () {
            var actual = children.first(function (x) {
                return x.sex == 'm';
            }).name;
    ...
    describe("last", function () {
        ...
        it("Exercise test 2", function () {
            var actual = children.last(function (x) {
                return x.sex == 'f';
            }).name;
    ...
    describe("count", function () {
        ...
        it("Exercise test 2", function () {
            var actual = children.count(function (x) {
                return x.sex === 'f';
            });
    ...
    describe("index", function () {
        ...
        it("Exercise test 1", function () {
            var actual = children.index(function (x) {
                return x.name == 'bany';
            });
    ...
    describe("sum", function () {
        ...
        it("Sums with spec", function () {
            var actual = [1, 3, 5, 7, 9, 11].sum(function (x) {
                return x * 2;
            });
    ...
    describe("max", function () {
        ...
        it("Children name", function () {
            var actual = children.max(function (a, b) {
        ...
        it("Person age", function () {
            var actual = people.max(function (a, b) {
                return a.age - b.age;
            }).name;
    ...
    describe("min", function () {
        ...
        it("Children name", function () {
            var actual = children.min(function (a, b) {
                return a.name.length - b.name.length
            }).name;
        ...
        it("Person age", function () {
            var actual = people.min(function (a, b) {
                return a.age - b.age;
            }).name;
